...
# controls when an attribute is retrieved
...
class Book:
    ...
    def __getattribute__(self, name):
        if name == "price":
            p = super().__getattribute__("price") # use the super attribute instead else it will crash
...
# b1.price = 38.95
# b1.price = float(40)
print(b1.randomprop) # since there is no attribute called 'randomprop' it will call the 
 # __getattr__ 
